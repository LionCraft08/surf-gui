package dev.slne.packetuxui.menu.menu
...
import dev.slne.packetuxui.common.*
...
import dev.slne.packetuxui.menu.button.ButtonBuilderDslMarker
import dev.slne.packetuxui.menu.button.click.ExecutableComponent
import dev.slne.packetuxui.menu.button.click.ExecutableComponentMarker
...
class MenuBuilderDsl(val type: MenuType) {
    ...
    fun button(slot: Int, builder: @ButtonBuilderDslMarker ButtonBuilder.() -> Unit) {
        buttons[slot] = dev.slne.packetuxui.menu.button.button(builder)
    }
